...
class CloneTest extends AbstractProxmoxTest {
    ...
    @Test
    void cloneContainer() throws Exception {
        wireMock.stubFor(post(urlEqualTo("/api2/json/nodes/pve/lxc/200/clone"))
            .willReturn(okJson("""
                {"data":"UPID:pve:00001234:ABCDEF01:65A1B2C3:vzclone:200:root@pam:"}
                """)));
