...
class ResetTest extends AbstractProxmoxTest {

    @Test
    void resetVm() throws Exception {
        wireMock.stubFor(post(urlEqualTo("/api2/json/nodes/pve/qemu/100/status/reset"))
            .willReturn(okJson("""
                {"data":"UPID:pve:00001234:ABCDEF01:65A1B2C3:qmreset:100:root@pam:"}
                """)));

        var task = Reset.builder()
