...
class StopTest extends AbstractProxmoxTest {

    @Test
    void stopVm() throws Exception {
        wireMock.stubFor(post(urlEqualTo("/api2/json/nodes/pve/qemu/100/status/stop"))
            .willReturn(okJson("""
                {"data":"UPID:pve:00001234:ABCDEF01:65A1B2C3:qmstop:100:root@pam:"}
                """)));

        var task = Stop.builder()
