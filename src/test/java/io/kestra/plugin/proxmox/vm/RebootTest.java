...
class RebootTest extends AbstractProxmoxTest {
    ...
    @Test
    void rebootVm() throws Exception {
        wireMock.stubFor(post(urlEqualTo("/api2/json/nodes/pve/qemu/100/status/reboot"))
            .willReturn(okJson("""
                {"data":"UPID:pve:00001234:ABCDEF01:65A1B2C3:qmreboot:100:root@pam:"}
                """)));
